    ...
    <div className="min-h-screen bg-[#0B1D2A]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-12 text-white/75 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">The science of being near water</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">Fishing as active mindfulness</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">The social ritual of the fishing trip</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">Leave-the-phones-in-the-bag rule</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">Fishing with kids</h2>
            <p className="mb-3">
          ...
          <section>
            <h2 className="text-xl font-bold text-[#F2EDE2] mb-4">When it's hard to get out</h2>
            <p>

...
export function BucketListClient({ species }: BucketListClientProps) {
  ...
  if (catcherName === null) {
    return (
      <div className="min-h-screen bg-[#0B1D2A] flex flex-col items-center justify-center px-6 pb-24">
        <div className="w-full max-w-sm">
          <h1 className="text-3xl font-bold text-[#F2EDE2] mb-2 text-center">Bucket List</h1>
  ...
  // ── Main grid ──────────────────────────────────────────────────────────────
  return (
    <div className="min-h-screen bg-[#0B1D2A] pb-24">
      {/* Header */}
      <div className="px-4 pt-8 pb-4">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          <div>
            <h1 className="text-2xl font-bold text-[#F2EDE2]">Bucket List</h1>
        ...
        <div className="max-w-4xl mx-auto mt-3">
          <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#FFC423] rounded-full transition-all duration-500"
          ...
          {sortedSpecies.map((sp) => {
            ...
            return (
              ...
              >
                ...
                {/* Caught badge */}
                {caught && (
                  <div className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-[#FFC423] flex items-center justify-center">
                  ...
                  return (
                    <div key={c.id} className="flex items-start justify-between gap-2 rounded-lg bg-slate-50 px-3 py-2.5 text-sm">
                      <div className="min-w-0">
                        ...
                        {c.photoUrl && (
                          <a href={c.photoUrl} target="_blank" rel="noopener noreferrer" className="text-xs text-[#D9A61C] hover:underline">
                            View photo ↗
                          </a>
                        )}
                      </div>

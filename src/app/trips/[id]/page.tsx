                    ...
                    .map(([slot, entry]) => {
                      ...
                      return (
                        <div key={slot} className="flex items-center gap-2 text-sm mb-1">
                          ...
                          <span className="text-[#0F2635] text-xs">{display}</span>
                        </div>
                      );
                    })}
                </div>
          ...
          <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer border-0 shadow-sm rounded-2xl">
            <CardContent className="p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-[#0F2635]">Bookings</h3>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer border-0 shadow-sm rounded-2xl">
            <CardContent className="p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-[#0F2635]">Group</h3>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <Card className="hover:shadow-lg transition-all duration-200 cursor-pointer border-0 shadow-sm rounded-2xl">
            <CardContent className="p-5">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-[#0F2635]">Budget</h3>
              </div>

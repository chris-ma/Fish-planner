    ...
    <div className="min-h-screen bg-[#0A1C28] text-[#EAE2D0] print:bg-white print:text-black">
      ...
      <div className="max-w-xl mx-auto px-4 py-6 space-y-8">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {targetSpecies.map((name) => (
                <span
                  key={name}
                  className="px-3 py-1 rounded-full text-sm bg-teal-900/40 text-teal-300 border border-teal-700/40"
                >
                  {name}
                </span>
              ))}
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <p className="text-lg font-mono font-bold text-teal-400 tracking-widest">{trip.shareCode}</p>

  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-sm font-semibold text-[#0F2635]">
      ...
      {startDate && (
        <div className="mt-4 text-sm text-[#0F2635]">
          {endDate ? (
          ...
          {currentStep === 4 && (
            <div className="space-y-3">
              ...
              {destinations.length > 0 && (
                <div className="mt-4">
                  <p className="text-sm font-medium text-[#0F2635] mb-2">Fishing spots in this region</p>
                      ...
                      return (
                        <div key={dayKey} className="border border-slate-200 rounded-xl p-3 bg-white space-y-2">
                          ...
                          <div className="flex items-center justify-between flex-wrap gap-2">
                            <p className="text-sm font-semibold text-[#0F2635]">{formatDateKey(dayKey)}</p>
                            {selectedRegions.length > 0 && (
                              <div className="flex flex-wrap gap-1">
                                {selectedRegions.map((slug) => {
                                  const region = REGION_OPTIONS.find((r) => r.slug === slug);
                          ...
                          {events.map((evt) => (
                            <div key={evt.id} className="flex items-center gap-2 bg-slate-50 rounded-lg px-3 py-2 text-sm">
                              ...
                              <span className="text-[#0F2635] flex-1 text-xs font-medium">
                                {evt.activity}
            ...
            <div className="space-y-4">
                  ...
                  {allSelectedSpecies.map((name) => {
                    ...
                    return (
                      <div key={name} className="text-sm">
                        <span className="font-medium text-[#0F2635]">{name}: </span>
              ...
              {selectedExperience && (
                <div className="bg-white rounded-xl border border-slate-200 p-4">
                  ...
                  <p className="text-sm font-medium text-[#0F2635]">{selectedExperience.name}</p>
                </div>
              )}
...
export function TripsNewClient() {

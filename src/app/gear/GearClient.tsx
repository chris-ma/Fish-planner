    ...
    <div>
      ...
      <div className="relative bg-[#0B1D2A] py-12 px-4 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          <p className="text-[#FFC423] text-sm font-semibold mb-2 tracking-wide uppercase">Gear Guide</p>
          <h1 className="text-4xl md:text-5xl font-bold text-[#F2EDE2] mb-3">What to Pack</h1>
            ...
            {(Object.keys(TRIP_TYPE_LABELS) as TripTypeFilter[]).map((t) => (
              <button
                ...
                className={cn(
                  ...
                  tripType === t
                    ? "bg-[#0B1D2A] text-white border-[#0B1D2A]"
                    : "bg-[#F2EDE2] text-slate-600 border-slate-200 hover:border-slate-400"
                )}
              >
                {TRIP_TYPE_LABELS[t]}
              </button>
          ...
          <div className="space-y-2">
            {filteredSpecies.map((sp) => {
              ...
              return (
                <div
                  key={sp.slug}
                  className="border border-slate-200 rounded-2xl overflow-hidden bg-[#F2EDE2] shadow-sm hover:shadow-md transition-shadow"
                >
                  {/* Card header */}
                  <button
                  ...
                  {isOpen && (
                    <div>
                      ...
                      <AccordionSection
                        title="Fishing Gear"
                        icon={<Fish className="h-4 w-4 text-[#FFC423]" />}
                        defaultOpen
                      >
                        ...
                        {addingFor === sp.slug ? (
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-1 text-sm px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FFC423]"
                            />
                            <button
                              type="button"
                              onClick={() => addCustomItem(sp.slug)}
                              className="px-3 py-1.5 bg-[#FFC423] text-[#0B1D2A] rounded-lg text-sm font-medium hover:bg-[#D9A61C]"
                            >
                              Add
                            </button>
                            <button
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 text-sm text-[#FFC423] hover:text-[#D9A61C] font-medium"
                          >

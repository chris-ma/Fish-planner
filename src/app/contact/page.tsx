      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-[#FFC423]/20 flex items-center justify-center">
            <MessageCircle className="h-5 w-5 text-[#FFC423]" />
          </div>
          <span className="text-[#FFC423] text-sm font-semibold uppercase tracking-wider">Contact</span>
        </div>

        <h1 className="text-4xl font-bold text-[#F2EDE2] mb-4 leading-tight">Get in touch</h1>
        ...
        <div className="space-y-4">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#FFC423]/15 flex items-center justify-center shrink-0">
              <Mail className="h-5 w-5 text-[#FFC423]" />
            </div>
            <div>
              <p className="font-semibold text-[#F2EDE2]">General enquiries</p>
          ...
          >
            ...
            <div>
              <p className="font-semibold text-[#F2EDE2]">Charter operator partnerships</p>

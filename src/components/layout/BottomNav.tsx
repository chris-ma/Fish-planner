...
import { Compass, Map, Sparkles, Plus, Star } from "lucide-react";
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-[1100] bg-[#0B1D2A] border-t border-white/10">
      <div className="flex items-stretch h-16">
        ...
        >
          <div className="w-12 h-12 rounded-full bg-[#FFC423] flex items-center justify-center shadow-lg shadow-[#FFC423]/40">
